  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative h-full bg-white border border-[#F2A64A]/15 p-8 rounded-2xl text-left space-y-5 shadow-sm hover:shadow-xl hover:shadow-[#F2A64A]/5 transition-shadow duration-300 cursor-pointer overflow-hidden group select-none flex flex-col justify-between"
      >
        ...
        {isHovered && (
          <div 
            ...
            style={{
              background: `radial-gradient(circle 180px at ${(coords.x + 0.5) * 100}% ${(coords.y + 0.5) * 100}%, rgba(242, 166, 74, 0.15) 0%, transparent 100%)`,
            }}
          />
        )}

        {/* Outer 3D back-glow */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#F2A64A]/5 to-[#F2A64A]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        <div className="space-y-4" style={{ transformStyle: 'preserve-3d' }}>
          ...
          <div 
            ...
            className="h-11 w-11 rounded-xl bg-[#F2A64A]/10 border border-[#F2A64A]/20 flex items-center justify-center text-[#F2A64A] group-hover:bg-gradient-to-br group-hover:from-brand-red group-hover:to-orange-500 group-hover:text-white group-hover:border-transparent group-hover:shadow-md group-hover:shadow-brand-red/15"
          >
            <IconComp className="h-5.5 w-5.5 transition-transform duration-300 group-hover:scale-105" />
          </div>
          ...
          <h3 
            ...
            className="font-display font-black text-xl text-[#1A1710] group-hover:text-brand-red transition-colors duration-300"
          >
            {title}
          </h3>
          ...
          <p 
            ...
            className="text-xs sm:text-sm text-[#1A1710]/70 leading-relaxed font-light"
          >
            {desc}
          </p>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-red to-orange-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left ease-out" />
      </motion.div>
    </div>
  );
}
...
export default function AboutView({ setActivePage }: AboutViewProps) {
  return (
    <div className="w-full">
      ...
      {/* SECTION 2: STUDIO BACKGROUND STORY */}
      ...
      {/* SECTION 3: FOUNDER SEGMENT */}
      <section className="py-24 px-4 bg-[#0A0A0D] border-t border-white/5 text-left">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-4 flex justify-center">
            <div className="relative group">
              ...
              <div className="relative h-[240px] w-[240px] rounded-full bg-card-bg border-4 border-[#0A0A0D] flex items-center justify-center overflow-hidden shadow-2xl">
                <img
                  src="https://lh3.googleusercontent.com/d/1oWQtnHolU8lV5whWO6r-EyUZm9y8pbU3"
          ...
          <div className="md:col-span-8 space-y-6">
            <div className="space-y-1">
              <span className="text-xs font-mono text-brand-red font-bold uppercase tracking-wider">Leadership</span>
      ...
      {/* SECTION 4: WHITE VALUES STRIP (LITTLE WHITE MIXTURE) */}
      <section className="py-20 px-4 bg-[#F7F4EE] text-[#1A1710]">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center max-w-xl mx-auto space-y-3">
            ...
            <h2 className="font-display font-black text-2xl sm:text-3xl text-[#1A1710] tracking-tight leading-none">
      ...
      <section className="py-20 px-4 bg-bg-black border-t border-white/5 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <button
            ...
            className="px-8 py-4 rounded-lg bg-brand-red hover:bg-brand-red-hover text-white text-xs font-bold transition-all shadow-md shadow-brand-red/15 cursor-pointer inline-flex items-center gap-1.5"
